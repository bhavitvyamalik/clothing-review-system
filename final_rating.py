...
PATH="C:\\Users\\bhavitvyamalik\\Desktop\\Training/task 1\\bert_output\\task2"
tokenization = run_classifier.tokenization
init_checkpoint = os.path.join(PATH, 'model.ckpt-375')
...
labels = ["1", "2", "3", "4", "5"] #modify based on the labels that you have
label_list=labels
MAX_SEQ_LENGTH = 128
is_lower_case = True
...
class Ratings:
    ...
    def getRatings(self, in_sentences):
        ...
        #2
        input_features = run_classifier.convert_examples_to_features(input_examples, label_list, MAX_SEQ_LENGTH, self.tokenizer) #[<bert.run_classifier.InputFeatures object at 0x0000015AF00D7448>]

        #3
        predict_input_fn = run_classifier.input_fn_builder(features=input_features, seq_length=MAX_SEQ_LENGTH, is_training=False, drop_remainder=False)     #function input_fn_builder.<locals>.input_fn at 0x0000015B23F65678
